      ...
      <main className="flex flex-1 flex-col gap-4 w-full md:gap-8">
        <div className="grid gap-4 md:grid-cols-2 md:gap-8 lg:grid-cols-4">
          ...
          <Card x-chunk="dashboard-01-chunk-0">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium">
                Total expenses <span className="text-green-500 text-sm"> (Inc. cost of goods sold)</span>
              </CardTitle>
              <DollarSign className="h-4 w-4 text-primary500" />
            </CardHeader>
            <CardContent>
          ...
          <Card x-chunk="dashboard-01-chunk-2">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              ...
              <span className="text-green-500 text-sm"> (Exc. cost of goods sold)</span>
              </CardTitle>
              <DollarSign className="h-4 w-4 text-primary500" />
            </CardHeader>
            <CardContent>
            ...
            <CardContent>
              <div className="grid grid-cols-2 gap-2 my-2">
                <div className="flex flex-col gap-4 items-center">
                  <p className="font-semibold text-green-400">{totalInv._count?.id || 0}</p>
                  <p>Quantity at hand</p>
                </div>
                <div className="flex flex-col gap-4 items-center">
                  <p className="text-red-500 font-semibold">{lowstock._count?.id || 0}</p>
                  <p>low stock</p>
                </div>
              </div>
