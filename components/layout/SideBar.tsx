                    ...
                    <div className="flex-1">
                        <nav className=" space-y-4 py-4 grid items-start px-2 text-sm font-medium lg:px-4">
                            ...
                            <Link
                                ...
                                className={`flex items-center gap-3 ${path.startsWith("transaction") && "dark:bg-primary100 text-primary bg-primary50 "} rounded-lg px-3 py-2 text-muted-foreground transition-all hover:text-primary`}
                            >
                                <LineChart className="h-4 w-4" />
                                Account Reports
                            </Link>
